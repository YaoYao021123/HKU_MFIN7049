(function () {
  function normalizeMath(input) {
    return input
      ...
      .replace(/\bai\b/g, "a_i")
      .replace(/\bxi\b/g, "x_i")
      .replace(/c\*_([A-Za-z])/g, "c^*_$1")
      .replace(/β_([A-Za-z])/g, "\\beta_$1")
      .replace(/β([A-Za-z])/g, "\\beta_$1")
      .replace(/α_([A-Za-z])/g, "\\alpha_$1")
      .replace(/α([A-Za-z])/g, "\\alpha_$1")
      .replace(/η_([A-Za-z])/g, "\\eta_$1")
      .replace(/η([A-Za-z])/g, "\\eta_$1")
      .replace(/\bRf\b/g, "R_f")
      .replace(/\bPV\b/g, "PV")
